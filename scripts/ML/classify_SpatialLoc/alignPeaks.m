...
% [p_b,loc_b]=findpeaks(N4.baro,'MinPeakHeight', 2500, 'MinPeakProminence',0.5)
% [p_n,loc_n]=findpeaks(deg01N1.ForceN,'MinPeakHeight', 4)
% [p_ir,loc_ir]=findpeaks(N4.ir,'MinPeakHeight', 9500, 'MinPeakWidth', 20)
...
%     N(:,i) = (deg050N1.ForceN(loc_n(i)-w_size:loc_n(i)+w_size));
    B(:,i) = (N4.baro(loc_b(i)-w_size:loc_b(i)+w_size));
    IR(:,i) = (N4.ir(loc_ir(i)-w_size:loc_ir(i)+w_size));
%     
%     
%     
