...
/***** USER PARAMETERS *****/
int i2c_ids_[] = {112};//,113};//, MUX_ADDR|1}; or {113}
...
#define PRESS_MEAS_DELAY_MS 1 //duration of each pressure measurement is twice this. (original: 20ms)

#define DELTA_MBAR_THRESH 1.0

#define I2C_FASTMODE 1

#define LOOP_TIME 1  // loop duration in ms (original: 20ms)
...
void loop() {
  ...
  readIRValues(); //-> array of IR values (3 bytes per sensor)
